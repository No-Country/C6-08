  ...
  return (
    <Container id="contenedor">
      ...
      <Form onSubmit={handleSubmit(onSubmit)} className="container-login">
        ...
        <Form.Group className="" controlId="formBasicDescription">
        ...
        <hr />
        {(errors.name || errors.price || errors.description || errors.location || errors.photo) && (
          <Alert variant="danger">Todos los campos son obligatorios</Alert>
        )}
        <Alert variant={alert.variant}>{alert.text}</Alert>
        <Button type="submit" className="boton-submit" variant="primary">
          Guardar
        </Button>
      </Form>
    </Container>
